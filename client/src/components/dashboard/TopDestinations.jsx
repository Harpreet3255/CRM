...
const mockDestinations = [
  { name: "Paris, France", requests: 847, trend: "+15%" },
  { name: "Tokyo, Japan", requests: 723, trend: "+22%" },
  { name: "Bali, Indonesia", requests: 612, trend: "+8%" },
  { name: "New York, USA", requests: 589, trend: "+12%" },
  { name: "Barcelona, Spain", requests: 456, trend: "+18%" },
];
