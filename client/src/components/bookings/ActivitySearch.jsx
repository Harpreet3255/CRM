...
const mockActivities = [
  {
    ...
    highlights: ["Dune bashing", "Camel ride", "Traditional BBQ", "Live shows"],
    aiRecommended: true
  },
  {
    id: 2,
    ...
    highlights: ["124th & 125th floor", "Sunset timing", "Fast-track entry"],
    aiRecommended: true
  },
  {
    id: 3,
    ...
    highlights: ["Private yacht", "Snacks & drinks", "Swimming stop", "Sunset views"],
    aiRecommended: false
  },
];
...
export default function ActivitySearch() {
  ...
  const handleSearch = async () => {
    ...
    setTimeout(() => {
      setResults(mockActivities);
      setLoading(false);
      toast.success('Found amazing activities!');
    }, 1500);
  };
